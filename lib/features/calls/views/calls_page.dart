      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Icon(Icons.access_time, size: 20, color: Theme.of(context).colorScheme.onSurfaceVariant),
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.calendar_month, size: 60, color: Theme.of(context).colorScheme.outline),
          const SizedBox(height: 16),
          Text(
            label,
